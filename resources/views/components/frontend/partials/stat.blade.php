    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:grid-cols-6 gap-6">
            ...
            <a href="/halaman-siswa"
                ...
                <div
                    class="absolute inset-0 bg-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-0">
                </div>
            </a>
            <!-- Statistik GTK -->
            <a href="/halaman-gtk"
                ...
                <div
                    class="absolute inset-0 bg-green-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-0">
                </div>
            </a>
            <!-- Statistik Ruangan -->
            <a href="/halaman-ruangan"
                ...
                <div
                    class="absolute inset-0 bg-red-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-0">
                </div>
            </a>
            ...
            <a href="/halaman-baru"
                ...
                <div class="relative z-20 text-center">
                    <h2 class="text-2xl font-bold">GTK</h2>
                </div>
                <div
                    class="absolute inset-0 bg-purple-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-0">
                </div>
            </a>
            ...
            <a href="/halaman-siswa"
                ...
                <div
                    class="absolute inset-0 bg-orange-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-10">
                </div>
            </a>

            <!-- Statistik Berita -->
            <a href="/halaman-berita"
                ...
                <div
                    class="absolute inset-0 bg-pink-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left z-10">
                </div>
            </a>
