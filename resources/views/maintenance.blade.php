...
<body
    class="bg-gradient-to-r from-blue-300 via-purple-300 to-pink-200 min-h-screen flex items-center justify-center overflow-hidden">

    <!-- component -->
    <div class="w-full max-w-4xl h-full flex flex-col items-center justify-between px-4 lg:px-0">
        <div class="flex-1 flex flex-col items-center justify-center text-center">
            <svg class="w-3/4 max-w-lg" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
            ...
            <p class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8">Website sedang dalam perawatan!
            </p>
            <p class="text-xl text-gray-700 uppercase mt-4">Kami akan segera kembali</p>
        </div>
        <div class="w-full py-4 border-t border-gray-300">
            <div
                ...
                <a href="mailto:{{ get_setting('email') }}" class="flex items-center space-x-1" target="_blank"
                    title="Email">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
