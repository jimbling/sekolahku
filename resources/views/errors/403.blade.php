        ...
        <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
            <div class="w-full">
                <div class="flex flex-col items-center max-w-lg mx-auto text-center">
                    <p class="text-sm font-medium text-blue-500">403 FORBIDDEN</p>
                    <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">Maaf, Anda tidak memiliki izin
                        mengakses halaman ini</h1>
                    <p class="mt-4 text-gray-600">Sepertinya Anda mencoba mengakses halaman yang tidak
                    ...
                    <div
                        ...
                        <a href="/"
                            class="w-full sm:w-auto px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:shrink-0 hover:bg-blue-600 dark:hover:bg-blue-500 ">
                            Website Sekolah
                        </a>
                    </div>
                </div>
