 <nav class="sticky-nav bg-blue-900 shadow-sm custom-nav-border">
                     ...
                     @if (isset($allMenus[$menu->id]) && $allMenus[$menu->id]->isNotEmpty())
                         ...
                         <div class="relative group" x-data="{ open: false }" @mouseenter="open = true"
                             ...
                             <div x-cloak x-show="open" x-transition
                                 class="absolute left-0 mt-2 w-56 max-h-96 overflow-y-auto rounded-md shadow-xl z-50 py-1 dropdown-dark">
