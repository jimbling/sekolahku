<footer class="footer-gradient-olive text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
    <!-- Main Footer Content -->
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div data-aos="fade-up" data-aos-delay="400">
            ...
            <form action="{{ route('subscribe') }}" method="POST" class="space-y-3">
                ...
                <p class="text-xs text-gray-400">Kami tidak akan membagikan email Anda ke pihak lain</p>
            </form>
        </div>
    </div>
    ...
    <!-- Copyright Section -->
    <div
        class="max-w-7xl mx-auto mt-16 pt-8 border-t border-overlay flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">

        {{-- Kiri: Copyright --}}
        <div class="mb-4 md:mb-0 text-center md:text-left text-white">
            &copy; {{ date('Y') }} {{ get_setting('school_name') }}. Tema {{ getActiveThemeName() }} by
        ...
        {{-- Kanan: Dibuat dengan cinta --}}
        <div class="flex items-center space-x-1 text-center md:text-right text-white">
            <span>Dibuat dengan sepenuh</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-pink-500" fill="currentColor"
                viewBox="0 0 24 24">
                <path
    ...
    document.addEventListener('DOMContentLoaded', function() {
        try {
            var disqus_config = function() {
                ...
                this.page.identifier = "{{ $post->id ?? 'generic_identifier' }}";
            };
