            ...
            <div class="max-w-full mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="relative overflow-hidden rounded-lg" style="padding-top: 42.25%;">
                    <iframe width="425" height="350"
                        src="https://www.openstreetmap.org/export/embed.html?bbox=110.13412803411485%2C-7.825419676890379%2C110.13616114854815%2C-7.823859879358742&amp;layer=mapnik"
                        style="border: 1px solid black"></iframe><br /><small><a
                            href="https://www.openstreetmap.org/?#map=19/-7.824640/110.135145">Lihat peta lebih
                            besar</a></small>
                </div>
            </div>
        </div>
