                    ...
                    <div
                        ...
                        <div class="p-6 flex-grow bg-white">
                            <div class="prose prose-sm max-w-none text-gray-700 leading-relaxed">
                                {{ \Illuminate\Support\Str::limit(strip_tags($comment->content), 200) }}
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('posts.show', ['id' => $comment->post->id, 'slug' => $comment->post->slug]) }}"
                                    ...
                                    title="{{ $comment->post->title ?? 'Tanpa Judul' }}">
        ...
        @else
            ...
            <div class="col-span-full" data-aos="fade-up">
                <div class="text-center p-12 bg-white rounded-xl shadow-md border border-gray-200">
                    <div
                        class="mx-auto w-32 h-48 bg-gray-50 rounded-full flex items-center justify-center mb-6 border-2 border-dashed border-gray-300">
