<footer class="footer-gradient-purple text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Copyright Section -->
    <div
        class="max-w-7xl mx-auto mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
        {{-- Kiri: Copyright --}}
        <div class="mb-4 md:mb-0 text-center md:text-left">
            &copy; {{ date('Y') }} {{ get_setting('school_name') }}. Tema {{ getActiveThemeName() }} by
            <a href="https://sinaucms.web.id/" class="text-blue-400 hover:underline">CMS Sinau</a>
        </div>

        {{-- Kanan: Dibuat dengan cinta --}}
        <div class="flex items-center space-x-1 text-center md:text-right">
            ...
            <span>oleh <a href="https://sinaucms.web.id/" class="text-blue-400 hover:underline">CMS Sinau</a></span>
        </div>
    </div>
