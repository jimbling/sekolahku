            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <table id="informasiTable" class="table table-sm table-striped table-hover"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
...
<div class="modal fade" id="addInformasi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.informasi.store') }}" method="POST" id="formTambahInformasi">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="message" id="message" rows="3" placeholder="Isi pesan informasi..."
                            required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="url">Tautan Terkait (opsional)</label>
        ...
        <div class="modal-content">
            ...
            <form id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="editUrl">URL (opsional)</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#informasiTable').DataTable({
            ...
            responsive: true,
            ordering: false,
            ajax: '{{ route('admin.publikasi.informasi.data') }}',
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
...
<script>
    $(document).ready(function() {
        // Tombol edit diklik
        $('#informasiTable').on('click', '.edit-btn', function() {
            var id = $(this).data('id');

            // Ambil data berdasarkan ID
            $.ajax({
                url: '/publikasi/informasi/' + id + '/fetch',
                type: 'GET',
...
<script>
    $('#informasiTable').on('click', '.delete-btn', function() {
        var InformasiId = $(this).data('id');
        var token = '{{ csrf_token() }}';
        var deleteUrl = '{{ route('admin.informasi.destroy', ':id') }}'.replace(':id', InformasiId);
...
<script>
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            ...
            $('#formTambahInformasi').submit(function(event) {
