                                ...
                                <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <!--[if mso]><table style="width:560px" cellpadding="0" cellspacing="0"><tr><td style="width:113px" valign="top"><![endif]-->
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://eooikyz.stripocdn.email/content/guids/CABINET_75da9b2a3d929e452796e2dbd9a96702/images/60551618226146901.png"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="75"></td>
                                                            </tr>
                                            ...
                                            <!--[if mso]></td><td style="width:20px"></td><td style="width:427px" valign="top"><![endif]-->
                                            <table cellpadding="0" cellspacing="0" align="right" role="none"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        <span
                                                                            style="background-color:#eeeeee">{{ $publishedAt }}</span>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0"><span
                                                                        ...
                                                                        style="border-style:solid;border-color:#5c68e2;background:#fefdfc;border-width:2px;display:inline-block;border-radius:5px;width:auto"><a
                                                                            href="{{ $postLink }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#5c68e2;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#fefdfc;border-radius:5px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #fefdfc">BACA
                                                                            SELENGKAPNYA</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="{{ get_setting('facebook') }}"
                                                                                    ...
                                                                                    <img src="https://eooikyz.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                                        alt="Fb" width="32"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="{{ get_setting('twitter') }}"
                                                                                    ...
                                                                                    <img src="https://eooikyz.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png"
                                                                                        alt="X" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </a>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="{{ get_setting('instagram') }}"
                                                                                    ...
                                                                                    <img src="https://eooikyz.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                        alt="Inst" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </a>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a href="{{ get_setting('youtube') }}"
                                                                                    ...
                                                                                    <img src="https://eooikyz.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                                                                        alt="Yt" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </a>
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ get_setting('school_name', 'CMS SINAU') }}
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
