                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://eooikyz.stripocdn.email/content/guids/CABINET_91d375bbb7ce4a7f7b848a611a0368a7/images/69901618385469411.png"
                                                                        alt="" width="100"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Kami menerima permintaan untuk mereset kata
                                                                        sandi akun Anda. Klik tombol di bawah ini
                                                                        untuk mengatur kata sandi baru.
                                                                        Setelah anda menekan tombol lakukan
                                                                        langkah-langkah dibawah ini:</p>
                                                                    <ol
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            Masukkan kata sandi baru.</li>
                                                                        <li
                                                                            style="color:#333333;margin:0px 0px 15px;font-size:14px">
                                                                            Konfirmasi kata sandi baru.</li>
                                                                        <li
                                                                            style="color:#333333;margin:0px 0px 15px;font-size:14px">
                                                                            Kirim Permintaan.</li>
                                                                    </ol>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Tautan reset kata sandi ini akan kedaluwarsa
                                                                        dalam 60 menit.</h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Jika Anda tidak dapat mengklik tombol, Anda bisa
                                                                        menggunakan tautan berikut:</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <a
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Jika Anda tidak meminta reset kata sandi, Anda
