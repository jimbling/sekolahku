...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['permission:edit_tags'])->group(function () {
        // Tags
    ...
    Route::middleware(['permission:edit_kutipan'])->group(function () {
        // Kutipan
    ...
    Route::middleware(['permission:edit_tautan'])->group(function () {
        // Tautan
    ...
    Route::middleware(['permission:edit_pengaturan'])->group(function () {
        // Pengaturan
    ...
    Route::middleware(['permission:edit_gtk'])->group(function () {
        // GTK
    ...
    Route::middleware(['permission:edit_file'])->group(function () {
        // Media - FILE
    ...
    Route::middleware(['permission:edit_video'])->group(function () {
        // Media - VIDEO
    ...
    Route::middleware(['permission:edit_menu'])->group(function () {
        // TAMPILAN - Menu
    ...
    Route::middleware(['permission:edit_rombel'])->group(function () {
        // ROMBEL
    ...
    Route::middleware(['permission:edit_pd'])->group(function () {
        // PESERTA DIDIK AKTIF
    ...
    Route::middleware(['permission:edit_tahun_pelajaran'])->group(function () {
        // TAHUN PELAJARAN
    ...
    Route::middleware(['permission:edit_kelas'])->group(function () {
        // KELAS
